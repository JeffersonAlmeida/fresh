	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.option}">
				<li class="fieldcontain">
					<span id="option-label" class="property-label"><g:message code="book.option.label" default="Option" /></span>
					
						<span class="property-value" aria-labelledby="option-label"><g:fieldValue bean="${bookInstance}" field="option"/></span>
